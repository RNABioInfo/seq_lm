...
workflow {
    Path root = java.nio.file.Files.createTempDirectory('seq-lm-de-publish-')
    Path results = root.resolve('batch_7')
    Path condition = results.resolve('group_treated_vs_control')
